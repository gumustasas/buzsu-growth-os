...
BUZSU'nun CodeIgniter 4 + Next.js + Airtable/n8n entegrasyon yüzeyine uygulanabilir kısmı kapsar.

| Genel Güvenlik Alanı | BUZSU Yüzeyi | İlgili Skill |
|---|---|---|
| Girdi doğrulama / injection önleme | CI4 form/checkout uçları | `skills/codeigniter4/`, `skills/php/` |
...
| Bağımlılık/tedarik zinciri | composer/npm paketleri | `skills/php/`, `skills/codeigniter4/` (yeni paket = MAJOR) |
