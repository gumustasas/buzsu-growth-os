# Skill: Schema Otomasyonu

## Amaç
Buzsu.com.tr ve Suvesu.com'da Schema.org yapısal verilerinin otomatik üretimi,
doğrulaması ve bakımını yönet. Ürün, FAQ, BreadcrumbList ve HowTo şemalarını
...
`skills/schema-automation` → Şema üretim pipeline'ı, doğrulama süreci, bakım otomasyonu
...
- Schema.org resmi belgeleri
- Google Search Central Structured Data yönergeleri

## Onay Notu
Şema canlı siteyi etkiler. MINOR/MAJOR sınıf, onay gerekir.
