# Coding — BUZSU Uygulama Adımları
...
Taslak: SAFE PATCH. Canlıya uygulama: MAJOR (branch + PR, insan onayı).

## İlgili Dosyalar

- `skills/debugging/` — hata ayıklama adımları
- `skills/refactoring/` — kodun yapısını değiştirme
- `skills/planning/` — önce planlama, sonra kodlama
- `playbooks/coding-playbook.md` — uçtan uca senaryo
