# Coding — Örnek Promptlar

1. "Suvesu.com'un iletişim formundan gelen veriler Airtable'a kaydedilmiyor. Sorunun
...
Her kodlama görevinde ilgili agent `tasks/` altında görev dosyası oluşturur, çıktıyı
`drafts/code/` altına yazar, `skill.md`'deki 4 prensip uygulanır.
